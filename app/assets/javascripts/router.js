  ...
  .config([
    ...
    function($stateProvider, $urlRouterProvider, $locationProvider, $translateProvider) {
      ...
      $translateProvider.translations('en', {
        ...
        'ADMIN_PRODUCT_ADD_FULL_DESCRIPTION': 'Full description',
        'ADMIN_PRODUCT_ADD_COMPLECT': 'Сontents of delivery',
        'ADMIN_PRODUCT_ADD_RAZMER': 'Sizes',
        'ADMIN_PRODUCT_ADD_AGE': 'Age',
        ...
        'ADMIN_PRODUCT_ADD_URL_VIDEO': 'Url video',
      ...
      $translateProvider.translations('ru', {
        ...
        'ADMIN_PRODUCT_ADD_FULL_DESCRIPTION': 'Полное описание',
        'ADMIN_PRODUCT_ADD_COMPLECT': 'Комплект поставки',
        'ADMIN_PRODUCT_ADD_RAZMER': 'Размеры',
        'ADMIN_PRODUCT_ADD_AGE': 'Возраст',
        ...
        'ADMIN_PRODUCT_ADD_URL_VIDEO': 'Url видео обзора',
